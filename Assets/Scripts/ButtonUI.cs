...
public class ButtonUI : MonoBehaviour {
    ...
    private enum JasonStatus {
        Right,
        Left,
        Idle
    }

    private JasonStatus jason1Status;
    private JasonStatus jason2Status;
    ...
    void Awake() {
        ...
        jason1FText.text = keyCodeCharList[Array.IndexOf(Enum.GetValues(jason1Controller.moveRightKey.GetType()), jason1Controller.moveRightKey)];
        jason1BText.text = keyCodeCharList[Array.IndexOf(Enum.GetValues(jason1Controller.moveLeftKey.GetType()), jason1Controller.moveLeftKey)];
        jason2FText.text = keyCodeCharList[Array.IndexOf(Enum.GetValues(jason2Controller.moveRightKey.GetType()), jason2Controller.moveRightKey)];
        jason2BText.text = keyCodeCharList[Array.IndexOf(Enum.GetValues(jason2Controller.moveLeftKey.GetType()), jason2Controller.moveLeftKey)];
        jason1Right = jason1Controller.moveRightKey;
        jason1Left = jason1Controller.moveLeftKey;
        jason2Right = jason2Controller.moveRightKey;
        jason2Left = jason2Controller.moveLeftKey;
        jason1Status = JasonStatus.Idle;
        jason2Status = JasonStatus.Idle;

        jason1Controller.walkingRight.AddListener(() => jason1Status = JasonStatus.Right);
        jason1Controller.walkingLeft.AddListener(() => jason1Status = JasonStatus.Left);
        jason1Controller.notWalking.AddListener(() => jason1Status = JasonStatus.Idle);

        jason2Controller.walkingRight.AddListener(() => jason2Status = JasonStatus.Right);
        jason2Controller.walkingLeft.AddListener(() => jason2Status = JasonStatus.Left);
        jason2Controller.notWalking.AddListener(() => jason2Status = JasonStatus.Idle);
    }

    void Update() {
        if (jason1Right != jason1Controller.moveRightKey || jason1Left != jason1Controller.moveLeftKey || jason2Right != jason2Controller.moveRightKey || jason2Left != jason2Controller.moveLeftKey) {
            jason1FText.text = keyCodeCharList[Array.IndexOf(Enum.GetValues(jason1Controller.moveRightKey.GetType()), jason1Controller.moveRightKey)];
            jason1BText.text = keyCodeCharList[Array.IndexOf(Enum.GetValues(jason1Controller.moveLeftKey.GetType()), jason1Controller.moveLeftKey)];
            jason2FText.text = keyCodeCharList[Array.IndexOf(Enum.GetValues(jason2Controller.moveRightKey.GetType()), jason2Controller.moveRightKey)];
            jason2BText.text = keyCodeCharList[Array.IndexOf(Enum.GetValues(jason2Controller.moveLeftKey.GetType()), jason2Controller.moveLeftKey)];
        ...
        switch (jason1Status) {
            case JasonStatus.Idle:
                jason1Forward.transform.localScale = defaultSize;
                jason1Back.transform.localScale = defaultSize;
                break;
            case JasonStatus.Right:
                jason1Forward.transform.localScale = biggerSize;
                jason1Back.transform.localScale = defaultSize;
                break;
            case JasonStatus.Left:
                jason1Forward.transform.localScale = defaultSize;
                jason1Back.transform.localScale = biggerSize;
                break;
        }

        switch (jason2Status) {
            case JasonStatus.Idle:
                jason2Forward.transform.localScale = defaultSize;
                jason2Back.transform.localScale = defaultSize;
                break;
            case JasonStatus.Right:
                jason2Forward.transform.localScale = biggerSize;
                jason2Back.transform.localScale = defaultSize;
                break;
            case JasonStatus.Left:
                jason2Forward.transform.localScale = defaultSize;
                jason2Back.transform.localScale = biggerSize;
                break;
        }
    }
}
